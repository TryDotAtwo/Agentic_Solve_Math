...
| C4 | CayleyPy-444-Cube | https://www.kaggle.com/competitions/cayley-py-444-cube | CayleyPy_444_Cube/ | in_progress | CayleyPy_444_Cube/docs/*.md |
...
- Intake и первичный brief: `BASELINE_INTAKE_SPEC.md`, `KAGGLE_AUTONOMOUS_WORKFLOW.md`.
- Общий исследовательский контекст: `RESEARCH_JOURNAL.md`.
